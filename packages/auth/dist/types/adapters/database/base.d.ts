...
export declare abstract class UserAdapter {
     ...
     * @param {import('../../types.js').OAuthProfile} profile - OAuth profile
     ...
     * @param {string} id - User ID
     * @param {Partial<import('../../types.js').User>} data - Fields to update
     * @returns {Promise<import('../../types.js').User>}
     */
     ...
     * @private
     */
    abstract getUserWithPasswordHash(email: string): Promise<(User & {
     ...
     * @returns {Promise<Object | null>} Full user object including password
     */
    getUserWithPasswordHashByIdentifier?(identifier: string, field?: string): Promise<(User & {
        password?: string | null;
    }) | null>;
}
