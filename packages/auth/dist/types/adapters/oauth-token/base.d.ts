...
export declare abstract class TokenAdapter {
     ...
     */
    abstract storeTokens(userId: string, provider: string, tokens: import("../../types/index.js").OAuthTokens): Promise<void>;
    /**
     ...
     */
    abstract getTokens(userId: string, provider: string): Promise<import("../../types/index.js").OAuthTokens | null>;
    /**
     ...
     */
    abstract refreshTokens(userId: string, provider: string): Promise<import("../../types/index.js").OAuthTokens | null>;
    /**
     * Delete OAuth tokens
     * @param {string} userId - User ID
     * @param {string} provider - Provider name
